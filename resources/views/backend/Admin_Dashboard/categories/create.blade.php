    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item"><a href="#" class="default-color">{{ trans('categories_trans.Create_Category') }}</a>
                </li>
    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <form method="post" enctype="multipart/form-data" action="{{ Route('admin.categories.store') }}" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <x-backend.form.textarea label="{{ trans('categories_trans.Description') }}" name="description" />
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="border rounded-lg text-center p-3">
                                <img src="{{ asset('backend/assets/images/profile-avatar.jpg') }}" height="200" width="200" class="img-fluid" id="frame" />
                            </div>
                        </div>
                    </div>
                    ...
                    <button type="submit" class="btn btn-success btn-md nextBtn btn-lg ">{{ trans('categories_trans.Add') }}</button>
