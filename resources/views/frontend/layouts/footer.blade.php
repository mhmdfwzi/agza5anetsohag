           ...
           <div class="float-buttons">
                     ...
                     <div class="d-flex justify-content-center">
                               <a href="https://api.whatsapp.com/send?phone=+201555361715" target="_blank">
                                         <img src="{{ asset('frontend/assets/images/whatsapp_logo.webp') }}"
                     ...
                     <div class="d-flex justify-content-center">
                               <a href="tel:+201555361715" target="_blank">
                                         <img src="{{ asset('frontend/assets/images/phone_icon.png') }}" alt="WhatsApp"
                                                   class="phone-icon">
                               </a>
                     </div>
           </div>
                                         ...
                                         <div class="row">
                                                                       ...
                                                                       <ul class="app-btn">
                                                                                 <li>
                                                                                           <a
                                                                                                     ...
                                                                                                     <span
                                                                                                               class="small-title">Download
                                                                                                               on
                                                                                                               the</span>
                                                                                                     <span
                                                                                                               class="big-title">Google
                                                                                                               Play</span>
                                                                                           </a>
                                                                                 </li>
                                                                       </ul>
                                                   ...
                                                   <div class="col-lg-3 col-md-6 col-12">
                                                             ...
                                                             <div class="single-footer f-link">
                                                                       <h3>معلومات عنا</h3>
                                                                       <ul>
                                                                                 <li><a href="javascript:void(0)">About
                                                                                                     Us</a></li>
                                                                                 <li><a href="javascript:void(0)">Contact
                                                                                                     Us</a></li>
                                                                                 <li><a href="javascript:void(0)">Downloads</a>
                                                                                 </li>
                                                                                 <li><a href="javascript:void(0)">Sitemap</a>
                                                                                 </li>
                                                                                 <li><a href="javascript:void(0)">FAQs
                                                                                                     Page</a></li>
                                                                       </ul>
                                                             </div>
                                                             <!-- End Single Widget -->
          ...
          $("#search").autocomplete({
                    ...
                    select: function(event, ui) {
                              ...
                              window.location.href =
                                        ...
                                        .replace(':id', ui.item.value)
                                        .replace(':slug', ui.item
                                                  .slug);
                              return false;
                    },
