                                        ...
                                        <div class="modal-header">
                                                  <div class="form-group input-group">
                                                            ...
                                                            <input autofocus class="form-control" type="text"
                                                                      id="search" placeholder=" انتا بتدور على ايه؟  "
                                        ...
                                        <div class="header-item-center">
                                                  ...
                                                  <nav class="menu">
                                                            ...
                                                            <ul class="menu-section" style="direction: rtl">
                                                                      ...
                                                                      <li><a href="{{ route('offers.index') }}">العروض</a>
                                                                      </li>
                                                                      <li class="nav-item"><a
                                                                                          href="{{ route('shop_grid.index') }}">
                                                                                          معرض المنتجات</a></li>
                                                                      ...
                                                                      <li class="menu-item-has-children contacts">
                                                                                <a
                                                                                          href="{{ route('shop_grid.index', $main_category->id) }}">{{ $main_category->name }}
                                                                                          <i
                                                                                                    class="ion ion-ios-arrow-down"></i></a>
                                                                                <div class="menu-subs menu-column-1">
                                                                                          <ul>
